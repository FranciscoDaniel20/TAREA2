...
public class ventana1 extends javax.swing.JFrame {
    ...
    public ventana1() {
        initComponents();
        this.setTitle("Gasolinera MonteCarlos");
        Image icono=Toolkit.getDefaultToolkit().getImage(getClass().getResource("/img/OIP.jpg"));
        this.setIconImage(icono);
        this.setLocationRelativeTo(null);
        Image iconoAgregar=Toolkit.getDefaultToolkit().getImage(getClass().getResource("/img/OIP.jpg"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Laboratorio No. 1 Francisco Daniel Samayoa Galdamez");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 670, 40));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, -1, 40));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 255));
        jLabel4.setText("PRECIO:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 80, 30));

        btnAgregar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/OIP.jpg"))); // NOI18N
        btnAgregar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAgregarActionPerformed(evt);
            }
        });
        getContentPane().add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 20, 150, 150));
        ...
        getContentPane().add(cboProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 60, 310, 30));
        ...
        getContentPane().add(spnCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 160, 60, 40));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 250, 90, 20));
        ...
        getContentPane().add(lblPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 210, 140, -1));

        lblTotal.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lblTotal.setForeground(new java.awt.Color(255, 0, 0));
        lblTotal.setText("Q 0.00 GTX");
        getContentPane().add(lblTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 250, 100, 20));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 0, 255));
        jLabel6.setText("IMPORTE:");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 210, -1, -1));

        lblImporte.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lblImporte.setForeground(new java.awt.Color(255, 0, 0));
        lblImporte.setText("Q 0.00 GTX");
        getContentPane().add(lblImporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 210, -1, -1));
        ...
        getContentPane().add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 90, 110, 50));
